...
import { useCreateManagerSaleMutation } from "../../../../Redux/features/sales/salesApi";
...
const ManagerSellFrom: React.FC<SellFormProps> = ({
  selectedGadget,
  onClose,
  refetchData,
  updateLocalData,
  ...
  const [quantityExceedsAvailable, setQuantityExceedsAvailable] =
    useState(false);
  const [createSale, { isLoading, isError }] = useCreateManagerSaleMutation();
...
export default ManagerSellFrom;
